...
Revision ID: 002
Revises: 001
Create Date: 2024-03-14 10:30:00.000000
...
def upgrade() -> None:
    ...
    op.create_index('ix_form_checks_exercise_id', 'form_checks', ['exercise_id'])
    ...
    op.create_index('ix_workout_exercises_order', 'workout_exercises', ['order'])
    ...
    op.create_index('ix_workout_plan_workouts_week_number', 'workout_plan_workouts', ['week_number'])
    op.create_index('ix_workout_plan_workouts_day_of_week', 'workout_plan_workouts', ['day_of_week'])
...
def downgrade() -> None:
    ...
    op.drop_index('ix_workout_plan_workouts_day_of_week', 'workout_plan_workouts')
    op.drop_index('ix_workout_plan_workouts_week_number', 'workout_plan_workouts')
    ...
    op.drop_index('ix_workout_exercises_order', 'workout_exercises')
    ...
    op.drop_index('ix_form_checks_exercise_id', 'form_checks')
