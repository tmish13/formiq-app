...
const exercises = [
  ...
  },
  {
    ...
    duration: '8 min',
    difficulty: 'Beginner',
    thumbnail: '/placeholder.svg?height=80&width=80&text=Pushup',
    focusPoints: ['Core stability', 'Shoulder alignment', 'Wrist position', 'Full range'],
    description: 'Build upper body strength with proper push-up technique',
  },
  {
    id: 8,
    ...
    duration: '6 min',
    difficulty: 'Intermediate',
    thumbnail: '/placeholder.svg?height=80&width=80&text=Plank',
    focusPoints: ['Core engagement', 'Neutral spine', 'Shoulder stability', 'Breathing'],
    description: 'Strengthen your core with dynamic plank exercises',
  },
  {
    id: 9,
    ...
    duration: '5 min',
    difficulty: 'Beginner',
    thumbnail: '/placeholder.svg?height=80&width=80&text=Ankle',
    focusPoints: ['Dorsiflexion', 'Calf stretch', 'Joint mobility', 'Balance'],
    description: 'Improve ankle flexibility for better squat depth',
  },
  {
    id: 10,
    ...
    focusPoints: ['Spinal decompression', 'Hip flexor release', 'Core activation'],
    description: 'Relieve lower back tension and improve mobility',
  },
];
...
export default function ExerciseLibraryPage() {
  ...
  const handleExerciseClick = (exercise: any) => {
    toast({
      ...
      description: `${exercise.title} tutorial will be available soon!`,
      duration: 2000,
    });
  };
              ...
              <div className="grid grid-cols-3 gap-6 text-center">
                ...
                <div>
                  <div className="text-2xl font-bold text-green-600 dark:text-green-400">
                    {Math.round(exercises.reduce((acc, ex) => acc + parseInt(ex.duration), 0) / exercises.length)}min
                  </div>
