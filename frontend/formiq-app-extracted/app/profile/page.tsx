  ...
  useEffect(() => {
    ...
    if (savedProgress) {
      ...
      setUserStats({
        ...
        avgFormScore: progress.avgFormScore || 0,
            ...
            <CardContent className="p-8">
              <div className="flex items-center space-x-6 mb-8">
                ...
                <div className="flex-1">
                  <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-1">Demo User</h2>
                  <p className="text-gray-600 dark:text-gray-400 mb-3">demo@formiq.ai</p>
              ...
              <div className="grid grid-cols-3 gap-6 pt-6 border-t border-gray-200/60 dark:border-gray-700/60">
                ...
                <div className="text-center border-x border-gray-200/60 dark:border-gray-700/60">
                  <div className="text-3xl font-bold text-green-600 dark:text-green-400">{userStats.avgFormScore}%</div>
              ...
              <CardContent className="p-0">
                {group.items.map((item, itemIndex) => (
                  <motion.div
                    ...
                    className={`flex items-center justify-between p-5 cursor-${item.clickable ? "pointer" : "default"} transition-colors ${
