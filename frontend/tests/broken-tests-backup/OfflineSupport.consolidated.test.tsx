...
import { setOffline } from '../../src/store/slices/uiSlice';

// Mock implementations
jest.mock('../../src/services/storageService', () => {
  const originalModule = jest.requireActual('../../src/services/storageService');
...
jest.mock('../../src/serviceWorkerRegistration', () => ({
