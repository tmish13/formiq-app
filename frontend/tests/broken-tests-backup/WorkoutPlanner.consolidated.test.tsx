...
import { Workout, WorkoutPlan } from '../../src/types';
...
jest.mock('../../src/hooks/useWorkoutTracking');
...
describe('WorkoutPlanner Consolidated Tests', () => {
  ...
  describe('Workout Service Integration', () => {
    const workoutService = require('../../src/services/workoutService').workoutService;
